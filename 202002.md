...
3. Task를 생성한다. 이때 Task는 약간 K8s의 Pod같은 느낌이다. 여러 개의 컨테이너를 정의할 수 있다. 따라서 한 Task에 존재하는 각 컨테이너의 수도 정해줄 수 있다.
   ...
   ![image-20200221171839742](/home/su/.config/Typora/typora-user-images/image-20200221171839742.png)
...
![image-20200221170857526](/home/su/.config/Typora/typora-user-images/image-20200221170857526.png)
